...
<head>
    ...
    @media (max-width: 991px) {
        .box {
            ...
            /* 2 kotak per baris di layar sedang */
        }
    }
    ...
    @media (max-width: 767px) {
        .box {
            flex-basis: 100%;
            /* 1 kotak per baris di layar kecil */
        }
    }
    </style>
</head>
    ...
    <div class="container mt-5 bg-dark text-white">
        ...
        <div class="container-boxes">
            ...
            <div class="box summary-box">
                ...
                <p><a href="lapo-adm" class="text-white no-deco">Lihat Detail</a></p>
            </div>
            ...
            <div class="box summary-box">
                ...
                <p class="fs-4"><?php echo $jumlahas; ?> Aspirasi</p>
                <p><a href="asp-adm" class="text-white no-deco">Lihat Detail</a></p>
            </div>
            ...
            <div class="box summary-box">
                ...
                <h3 class="fs-2">komentar</h3>
                <p class="fs-4"><?php echo $jumlahkmn; ?> komentar</p>
                <p><a href="twt" class="text-white no-deco">Lihat Detail</a></p>
            </div>
