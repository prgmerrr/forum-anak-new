        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted">Tanggal: <?php echo $row['tanggal']; ?></small>
                    </p>
                    <p class="card-text"><small class="text-muted">Status: <?php echo $row['status']; ?></small></p>
