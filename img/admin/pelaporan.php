...
<body>
    ...
    <div class="container">
        ...
        <div class="laporan-list">
            ...
            <?php
            // Kode PHP untuk mengambil data dari database dan menghasilkan HTML
            // Koneksi ke database
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    $kontak = $row["nomor_hp"];
                        ...
                        if (strlen($laporan) > 0) {
                            echo substr($laporan, 0, 20) . '<span class="hidden-text">' . substr($laporan, 0) . '</span>';
                        ...
                        echo '<p><span class="pink-text">Alama:</span>' . $alamat . '</p>';
                        echo '<p>Waktu Laporan Dibuat: <span class="timestamp">' . $timestamp . '</span></p>'; // Display the timestamp
                        if ($anonimus) {
